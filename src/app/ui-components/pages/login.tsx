    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="mb-10 text-center">
          ...
          <p className="text-[15px] text-slate-500 mt-2 font-medium leading-relaxed">Sign in to manage your hiring pipeline</p>
        </div>
        ...
        <p className="text-center text-[14px] text-slate-500 mt-8 font-medium">
          ...
          <Link href="/sign-up" className="text-blue-600 hover:text-blue-700 font-bold ml-1">
            Create account
          </Link>
        </p>
      </div>
