      ...
      <div className="hidden lg:flex w-1/2 p-12 flex-col justify-center items-center relative">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-xl text-gray-300 mb-12">
            Your next-gen hiring companion ✨
          </motion.p>
          ...
          >
            <div className="flex items-start space-x-3">
              ...
              <div className="text-left">
                <h3 className="font-semibold mb-1">Smart Hiring</h3>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-left">
                <h3 className="font-semibold mb-1">Seamless Flow</h3>
                <p className="text-sm text-gray-400">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Mail className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 group-hover:text-blue-400" />
                    <Input
                      id="email"
                      type="email"
                      placeholder="m@example.com"
                      className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-blue-400 focus:ring-blue-400/10"
                      value={email}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 group-hover:text-blue-400" />
                    <Input
                      id="password"
                      type="password"
                      className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-blue-400 focus:ring-blue-400/10"
